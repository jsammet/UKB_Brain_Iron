...
def main():
    ...
    # train model
    model, history = trainer(model, train_indices, params, optimizer, criterion, scheduler)
    ...
    tester(model, test_indices, params, criterion)

    # saliency retrival
    test_saliency(model, test_indices, params, criterion)
